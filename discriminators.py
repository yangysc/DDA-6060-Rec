# Adapted from https://github.com/yunqi-li/Personalized-Counterfactual-Fairness-in-Recommendation/blob/main/src/models/Discriminators.py
import os
import logging
import torch
...
class Discriminator(nn.Module):
    ...
    def __init__(self, embed_dim, out_dim=2, random_seed=2020, dropout=0.3, neg_slope=0.2,
                 model_dir_path='../model/Model/', model_name='', name='gender'):
        super().__init__()
...
class BinaryDiscriminator(nn.Module):
    ...
    def parse_disc_args(parser):
        parser.add_argument('--neg_slope', type=float,
                            ...
                            help='negative slope for leakyReLU.')
        return parser
    def __init__(self, embed_dim, random_seed=2020, dropout=0.3, neg_slope=0.2,
                 model_dir_path='../model/Model/', model_name='', name='gender'):
        super().__init__()
        self.embed_dim = int(embed_dim)
        self.random_seed = random_seed
